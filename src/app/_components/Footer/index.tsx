    ...
    <footer className={styles.main}>
      ...
      <div className={styles.inner}>
        <div className={styles.content}>
          <p>La consulta popular estará abierta desde el 10 de julio hasta el 10 de octubre de 2023. Los resultados serán entregados al Congreso de la Nación.</p><br/>
